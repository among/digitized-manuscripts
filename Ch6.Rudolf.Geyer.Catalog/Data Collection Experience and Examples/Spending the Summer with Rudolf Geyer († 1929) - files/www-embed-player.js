...
function b(r){for(var v=g,p=0;64>p;p+=4)v[p/4]=r[p]<<24|r[p+1]<<16|r[p+2]<<8|r[p+3];for(p=16;80>p;p++)r=v[p-3]^v[p-8]^v[p-14]^v[p-16],v[p]=(r<<1|r>>>31)&4294967295;r=e[0];var D=e[1],J=e[2],pa=e[3],uc=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var Ka=pa^D&(J^pa);var Gb=1518500249}else Ka=D^J^pa,Gb=1859775393;else 60>p?(Ka=D&J|pa&(D|J),Gb=2400959708):(Ka=D^J^pa,Gb=3395469782);Ka=((r<<5|r>>>27)&4294967295)+Ka+uc+Gb+v[p]&4294967295;uc=pa;pa=J;J=(D<<30|D>>>2)&4294967295;D=r;r=Ka}e[0]=e[0]+r&4294967295;e[1]=
e[1]+D&4294967295;e[2]=e[2]+J&4294967295;e[3]=e[3]+pa&4294967295;e[4]=e[4]+uc&4294967295}
...
window.console.log(c.join("\n"),e)),e=a.stacktrace,c=a.columnNumber,a.hasOwnProperty("params")&&(d=String(JSON.stringify(a.params)),f.params=d.substr(0,500)),a=Wb(a),e=e||a.stack,d=a.lineNumber.toString(),isNaN(d)||isNaN(c)||(d=d+":"+c),window.yterr&&Ca(window.yterr)&&window.yterr(a),Ne[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={Xa:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},D:{url:P("PAGE_NAME",window.location.href),
file:a.fileName},method:"POST"};f.version&&(b["client.version"]=f.version);e&&(b.D.stack=e);for(var g in f)b.D["client."+g]=f[g];if(g=P("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var h in g)b.D[h]=g[h];Be(P("ECATCHER_REPORT_HOST","")+"/error_204",b);Ne[a.message]=!0;Oe++}}
...
function mg(a,b,c,d){!P("VISITOR_DATA")&&.01>Math.random()&&Q(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",D:c,ma:"JSON",N:function(){d.N()},
...
c.ka=function(v,p){Cg(l);r(v,p)}}try{R("use_fetch_for_op_xhr")?ye(k,e):(e.method="POST",e.D||(e.D={}),Be(k,e))}catch(v){if("InvalidAccessError"==v)l&&(Cg(l),l=0),Q(Error("An extension is blocking network request."),"WARNING");
...
;function Og(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||ab(b);this.assets=a.assets||{};this.attrs=a.attrs||ab(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
...
;function Vg(a,b){L.call(this);this.l=this.U=a;this.R=b;this.o=!1;this.api={};this.S=this.B=null;this.C=new N;Tc(this,Ia(Uc,this.C));this.i={};this.J=this.T=this.h=this.Z=this.f=null;this.F=!1;this.j=this.A=null;this.V={};this.qa=["onReady"];this.Y=null;this.ha=NaN;this.P={};Wg(this);this.W("WATCH_LATER_VIDEO_ADDED",this.Ja.bind(this));this.W("WATCH_LATER_VIDEO_REMOVED",this.Ka.bind(this));this.W("onAdAnnounce",this.sa.bind(this));this.ra=new Pg(this);Tc(this,Ia(Uc,this.ra))}
t(Vg,L);m=Vg.prototype;m.getId=function(){return this.R};
m.loadNewVideoConfig=function(a){if(!this.g){a instanceof Og||(a=new Og(a));this.Z=a;this.f=a.clone();this.h=this.f.attrs.id||this.h;"video-player"==this.h&&(this.h=this.R,this.f.attrs.id=this.R);this.l.id==this.h&&(this.h+="-player",this.f.attrs.id=this.h);this.T||(this.T=Xg(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=vc(Number(a)||a);if(a=this.f.attrs.height)this.l.style.height=vc(Number(a)||a);Yg(this);this.o&&
Zg(this)}};
...
function Yg(a){if(!a.g&&!a.F){var b=$g(a);if(b&&"html5"==(ah(a)?"html5":null))a.J="html5",a.o||bh(a);else if(ch(a),a.J="html5",b&&a.j)a.U.appendChild(a.j),bh(a);else{a.f.loaded=!0;var c=!1;a.A=function(){c=!0;var d=a.f.clone();z("yt.player.Application.create")(a.U,d);bh(a)};
a.F=!0;b?a.A():(hf(a.f.assets.js,a.A),Rg(a.f.assets.css),dh(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function ah(a){var b=ac(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function bh(a){if(!a.g){var b=ah(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.F=!1,b.isNotServable&&b.isNotServable(a.f.args.video_id)||eh(a)):a.ha=S(function(){bh(a)},50)}}
function eh(a){Wg(a);a.o=!0;var b=ah(a);b.addEventListener&&(a.B=fh(a,b,"addEventListener"));b.removeEventListener&&(a.S=fh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=fh(a,b,e))}for(var f in a.i)a.B(f,a.i[f]);Zg(a);a.T&&a.T(a.api);a.C.L("onReady",a.api)}
...
function Wg(a){a.o=!1;if(a.S)for(var b in a.i)a.S(b,a.i[b]);for(var c in a.P)T(parseInt(c,10));a.P={};a.B=null;a.S=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.W.bind(a);a.api.removeEventListener=a.Oa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.wa.bind(a);a.api.getPlayerType=a.xa.bind(a);a.api.getCurrentVideoConfig=a.va.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ia.bind(a)}
m.Ia=function(){return this.o};
m.W=function(a,b){var c=this,d=Xg(this,b);if(d){if(!(0<=La(this.qa,a)||this.i[a])){var e=gh(this,a);this.B&&this.B(a,e)}this.C.subscribe(a,d);"onReady"==a&&this.o&&S(function(){d(c.api)},0)}};
m.Oa=function(a,b){if(!this.g){var c=Xg(this,b);c&&Fd(this.C,a,c)}};
...
function gh(a,b){var c="ytPlayer"+b+a.R;a.i[b]=c;u[c]=function(d){var e=S(function(){if(!a.g){a.C.L(b,d);var f=a.P,g=String(e);g in f&&delete f[g]}},0);
Za(a.P,String(e))};
return c}
...
m.xa=function(){return this.J||(ah(this)?"html5":null)};
m.wa=function(){return this.Y};
function ch(a){a.cancel();Wg(a);a.J=null;a.f&&(a.f.loaded=!1);var b=ah(a);b&&($g(a)||!dh(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.U;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.A&&of(this.f.assets.js,this.A);T(this.ha);this.F=!1};
...
rh.prototype.toString=function(){return this.topic};var sh=z("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.M;N.prototype.publish=N.prototype.L;N.prototype.clear=N.prototype.clear;y("ytPubsub2Pubsub2Instance",sh,void 0);y("ytPubsub2Pubsub2SubscribedKeys",z("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);y("ytPubsub2Pubsub2TopicToKeys",z("ytPubsub2Pubsub2TopicToKeys")||{},void 0);y("ytPubsub2Pubsub2IsAsync",z("ytPubsub2Pubsub2IsAsync")||{},void 0);
...
;var X=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function uh(){var a=P("TIMING_TICK_EXPIRATION");a||(a={},O("TIMING_TICK_EXPIRATION",a));return a}
function vh(){var a=uh(),b;for(b in a)tf(a[b]);O("TIMING_TICK_EXPIRATION",{})}
;function wh(a,b){qh.call(this,1,arguments)}
t(wh,qh);function xh(a,b){qh.call(this,1,arguments)}
t(xh,qh);var yh=new rh("aft-recorded"),zh=new rh("timing-sent");function Ah(){var a;(a=z("ytcsi.data_"))||(a={tick:{},info:{}},Ja("ytcsi.data_",a));return a}
function Bh(){var a=Ah().nonce;a||(a=Fg(),Ah().nonce=a);return a}
;function Ch(){return!!R("csi_on_gel")||!!Ah().useGel}
function Dh(){var a=Ah();if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function Eh(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Fh(a)||c.some(function(e){return!Fh(e)}))throw Error("Only objects may be merged.");
c=q(c);for(d=c.next();!d.done;d=c.next())Gh(a,d.value)}
function Gh(a,b){for(var c in b)if(Fh(b[c])){if(c in a&&!Fh(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});Gh(a[c],b[c])}else if(Hh(b[c])){if(c in a&&!Hh(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);Ih(a[c],b[c])}else a[c]=b[c];return a}
function Ih(a,b){for(var c=q(b),d=c.next();!d.done;d=c.next())d=d.value,Fh(d)?a.push(Gh({},d)):Hh(d)?a.push(Ih([],d)):a.push(d);return a}
function Fh(a){return"object"===typeof a&&!Array.isArray(a)}
function Hh(a){return"object"===typeof a&&Array.isArray(a)}
...
"playerInfo.preloadType",Y.yt_ad_pr="prerollAllowed",Y.pa="previousAction",Y.yt_red="isRedSubscriber",Y.st="serverTimeMs",Y.aq="tvInfo.appQuality",Y.br_trs="tvInfo.bedrockTriggerState",Y.label="tvInfo.label",Y.is_mdx="tvInfo.isMdx",Y.preloaded="tvInfo.isPreloaded",Y.query="unpluggedInfo.query",Y.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",Y.yt_vst="videoStreamType",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y),Lh="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),
Mh="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),Nh={},Oh=(Nh.mver="MEASUREMENT_VERSION_",Nh.pis="PLAYER_INITIALIZED_STATE_",Nh.yt_pt="LATENCY_PLAYER_",Nh.pa="LATENCY_ACTION_",Nh.yt_vst="VIDEO_STREAM_TYPE_",Nh),Ph=!1;
function Qh(){Ah().info.yt_lt="hot_bg";if(Ch()){var a="hot_bg";var b=Dh();(b.gelInfos?b.gelInfos:b).info_yt_lt=!0;if("yt_lt"in Kh){var c=Kh.yt_lt;0<=La(Mh,c)&&(a=!!a);"yt_lt"in Oh&&(a=Oh.yt_lt+a.toUpperCase());b={};c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];d[c[c.length-1]]=a;a=b}else 0<=La(Lh,"yt_lt")||(a=Error("Unknown label logged with GEL CSI"),a.params="yt_lt",fe(a)),a=void 0;a&&Ch()&&(b=Dh(),"gelInfos"in b||(b.gelInfos={}),Eh(b.gelInfos,a),b=Bh(),c=Object.keys(a).join(""),
oh("info_"+c+"_"+b)||(a.clientActionNonce=b,lh("latencyActionInfo",a)))}}
...
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function Sh(){return Ah().tick}
function Th(){var a=Sh(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Ah().info.yt_pvis}
function Uh(){vh();if(!Ch()){var a=Sh(),b=Ah().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&Aa(a[f])){var d=f.slice(1);if(d in Jh){var e=Na(a[f],function(l){return Math.round(l-c)});
b["all_"+d]=e.join()}delete a[f]}e=P("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:P("TIMING_ACTION",void 0)};d=Qh.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var g=window.location.protocol+z("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?b.h5jse=Math.round(b.h5jse-g.responseEnd):delete b.h5jse}a.aft=Rh();Th()&&"youtube"==e&&(Qh(),e=a.vc,g=a.pbs,delete a.aft,b.aft=Math.round(g-e));for(var h in b)"_"!=h.charAt(0)&&(f[h]=b[h]);a.ps=Rf();h={};e=[];for(var k in a)"_"!=
k.charAt(0)&&(g=Math.round(a[k]-c),h[k]=g,e.push(k+"."+g));f.rt=e.join(",");(a=z("ytdebug.logTiming"))&&a(f,h);Vh(f,!!b.ap);th(zh,new xh(h.aft+(d||0),void 0))}}
...
var Oi=ee(function(){var a=Sh(),b;(b=!R("use_first_tick"))||(b=!("ol"in Sh()));if(b){b="ol";X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b));b=Rf();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=uh();if(b=a.ol)tf(b),a.ol=0;a=Dh();a.gelTicks&&(a.gelTicks.tick_ol=!0);Rf();Ch()?(a=Bh(),oh("tick_ol_"+a)||lh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1;if(a=!a)a=!z("yt.timing.pingSent_");if(a&&(b=P("TIMING_ACTION",void 0),a=Sh(),z("ytglobal.timingready_")&&
b&&a._start&&(b=Rh()))){Ph||(th(yh,new wh(Math.round(b-a._start),void 0)),Ph=!0);b=!0;var c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Uh()}}a=Bi.getInstance();c=!!((Ei("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Xc(document.body,"exp-invert-logo")&&(b&&!Xc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Xc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":
